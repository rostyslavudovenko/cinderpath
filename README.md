...
![GitHub License](https://img.shields.io/github/license/rostyslavudovenko/cinderpath)
[![Conventional Commits](https://img.shields.io/badge/Conventional%20Commits-1.0.0-%23FE5196?logo=conventionalcommits&logoColor=white)](https://conventionalcommits.org)
![GitHub Release](https://img.shields.io/github/v/release/rostyslavudovenko/cinderpath?include_prereleases)
![GitHub commit activity](https://img.shields.io/github/commit-activity/m/rostyslavudovenko/cinderpath)
...
```bash
git clone https://github.com/rostyslavudovenko/cinderpath.git
cd cinderpath
```
